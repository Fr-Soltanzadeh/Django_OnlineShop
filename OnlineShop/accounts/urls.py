...
urlpatterns = [
    ...
    path("verify_code/api/v1/", api_views.VerifyCodeApiView.as_view(), name="verify_code_api"),
    path("profile/api/v1/", api_views.ProfileApiView.as_view(), name="profile_api"),
    path("refresh_token/api/v1/", api_views.RefreshTokenApiView.as_view(), name="refresh_token_api"),
]
